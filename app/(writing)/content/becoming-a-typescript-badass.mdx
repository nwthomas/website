...
<img
  alt="Typescript log on a white wall background"
  height="525"
  src="/images/blog/how-to-become-a-typescript-badass/typescript-on-wall.webp"
  width="1050"
/>
...
<img
  alt="VS Code screenshot of TypeScript error"
  height="224"
  src="/images/blog/how-to-become-a-typescript-badass/vscode-typescript-error.jpg"
  title="(Sorry for the junky screenshot)"
  width="1046"
/>
...
function printLabelWithInterfaceKeyword(labeledObj: LabeledObjWithInterfaceKeyword) {
  console.log(labeledObj.label);
}
```
...
<img
  alt="White wall with ivy to the left side of it"
  height="501"
  src="/images/blog/how-to-become-a-typescript-badass/ivy-wall.webp"
  width="1000"
/>
