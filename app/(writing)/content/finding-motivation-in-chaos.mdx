...
export const metadata = {
  ...
  description: "Change is a constant in life. Just keep working on yourself.",
  openGraph: {
    title: "Finding Motivation in Chaos",
    description: "Change is a constant in life. Just keep working on yourself.",
  },
...
> There are times in my life when I write almost more for myself than for others. It's usually about something I'm struggling with. Writing helps me process life experiences. This article was one of those times. I hope it helps you too.
...
It’s cold outside, but that doesn’t mean we can’t be warm.

> “I accept chaos, I’m not sure whether it accepts me.”
>
> — Bob Dylan

## Do the Things, Be the Things [#do-the-things-be-the-things]
...
_(I wrote an [article back in 2019 on this](https://www.nathanthomas.dev/the-pursuit-of-personal-fulfillment) that I apparently didn’t internalize.)_
...
## Accomplishments are Retroactive [#accomplishments-are-retroactive]
...
## Inaction is a Slow Death [#inaction-is-a-slow-death]
...
<Image
  alt="Jake the Dog from Adventure Time saying, 'Dude, sucking at something is the first step towards being sort of good at something'"
  height="266"
  src="/images/blog/finding-motivation-in-chaos/jake-the-dog-advice.gif"
  width="474"
/>
...
## Success is a Team Sport [#success-is-a-team-sport]
...
## Embrace the Chaos, Find Motivation [#embrace-the-chaos-find-motivation]
