import { ConcurrencyParallelismDiagram } from "@/app/(writing)/components/articles/concurrency-parallelism-diagram";
...
Python is the lingua franca of artificial intelligence (with TypeScript coming in a close second).
