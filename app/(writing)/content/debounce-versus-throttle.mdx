...
export const metadata = {
  ...
  description:
    "While they might seem the same, debounce and throttle actually have different use cases. Let's learn what they are!",
  openGraph: {
    title: "Debounce Versus Throttle",
    description:
      "While they might seem the same, debounce and throttle actually have different use cases. Let's learn what they are!",
...
# <span id="debounce-versus-throttle">Debounce Versus Throttle</span>
