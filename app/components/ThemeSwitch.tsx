...
export const THEME_LIGHT_MODE: Theme = "light";
export const THEME_DARK_MODE: Theme = "dark";
...
export function ThemeSwitch() {
  ...
  const handleThemeSwitchClick = (event: React.SyntheticEvent) => {
    ...
    localStorage.setItem("theme", isDarkMode ? THEME_LIGHT_MODE : THEME_DARK_MODE);
    setIsDarkMode(!isDarkMode);
    document.documentElement.classList.toggle(THEME_DARK_MODE);
  };
