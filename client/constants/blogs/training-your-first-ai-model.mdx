...
## Get an API Using Hugging Face and Gradio

The final piece of the puzzle is to create a Hugging Face account and host your model there so you can interact with it (using the Hugging Face site) or get an API link for it that will allow you to directly send images to it like any other API you might use.
