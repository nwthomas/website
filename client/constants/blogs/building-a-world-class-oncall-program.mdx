...
If oncall is stumped (since no one can possibly know _everything_ about this field), a high priority issue they receive a page about may also warrant manually paging in _other_ key team members for fixing the problem. You should advise your oncall engineers in their runbooks that this should only be used under extreme circumstances (more on runbooks in just a second).
...
These runbooks should include (at a minimum):
...
Please make sure to empower your oncall engineers to make active modifications to these runbooks when they deem it necessary. The team should view these as living documents; if you take it entirely on yourself (or a specific group) to periodically review these documents, you will almost certainly find them frequently falling out of use because the information is stale.

## Conclusion

It's not easy to build good team processes, and it's _especially_ not easy when a high degree of stress is involved.

You should take everything in this article and use it as a **foundation** to start your own oncall program. Over time, you'll come up with new best practices; this may feel like a moving target, but I mentioned before that perfection (in many cases) is impossible. Instead,
