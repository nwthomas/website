...
description: "This article will teach you GraphQL as well as how to build a small JavaScript server."
imageUrl: /images/blog/building-your-first-graphql-server/graphql-logo.webp
dateWritten: "2019-08-18"
...
<img alt="GraphQL logo on a cloud background" src="/images/blog/building-your-first-graphql-server/graphql-logo.webp" width="1050" height="525">

# Building Your First GraphQL Server

> I love building server architecture. While front-end might be a canvas of color that users associate with their favorite brands, the back-end is the secret sauce of any successful application.
>
> This article will teach you BOTH ExpressJS as well as GraphQL. I hope you enjoy reading it.
...
<img alt="Example graph" height="3168" src="/images/blog/building-your-first-graphql-server/example-graph.webp" width="4752">
...
<img alg="screenshot of VS Code setup for this article" height="931" src="/images/blog/building-your-first-graphql-server/vs-code-1.webp" width="1200">
...
<img alg="screenshot of VS Code running the example server" height="924" src="/images/blog/building-your-first-graphql-server/vs-code-2.webp" width="1200">
...
<img alg="Screenshot of the Supabase starting dashboard" height="1009" src="/images/blog/building-your-first-graphql-server/supabase-initial-dashboard.webp" width="1473">
...
<img alg="Screenshot of the Supabase new project setup modal" height="1009" src="/images/blog/building-your-first-graphql-server/supabase-new-project-setup.webp" width="1473">
...
<img alg="Screenshot of the Supabase new project dashboard with an arrow indicating where to click for Project Settings" height="1009" src="/images/blog/building-your-first-graphql-server/supabase-new-project.webp" width="1473">
...
<img alg="Screenshot of the Supabase new project dashboard with an arrow indicating where to click for Project Settings" height="1009" src="/images/blog/building-your-first-graphql-server/supabase-grab-database-url.webp" width="1473">
...
DATABASE_URL=<your_database_uri_link_goes_here>
```
...
<img alg="Orange sky with clouds" height="600" src="/images/blog/building-your-first-graphql-server/orange-clouds.webp" width="1200">
...
<img alg="Initial screen when firing up GraphQL Playground" height="1009" src="/images/blog/building-your-first-graphql-server/graphql-playground-initial.webp" width="1473">
...
<img alg="Dark water" height="600" src="/images/blog/building-your-first-graphql-server/dark-water.webp" width="1200">
...
<img alt="GraphQL Playground setup for a query" height="923" src="/images/blog/building-your-first-graphql-server/graphql-playground-query.webp" width="1200">
...
<img alt="GraphQL Playground setup for a mutation" height="923" src="/images/blog/building-your-first-graphql-server/graphql-playground-mutation.webp" width="1200">
...
<img alt="GraphQL Playground setup for introspecting types, mutations, and queries" height="923" src="/images/blog/building-your-first-graphql-server/graphql-playground-introspection.webp" width="1200">
