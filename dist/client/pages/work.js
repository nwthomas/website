    ...
    return (<Layout_1.default pageName={PAGE_NAME} withFooter>
      <RootStyles>
        <main>
          ...
          <section>
            <a href="https://github.com/nwthomas/personal-portfolio" aria-label="Link to portfolio site GitHub repository" rel="noopener noreferrer" target="_target">
              <img alt="Macbook with screenshot of Nathan's portfolio site on it" src="./portfolio-site.png"/>
